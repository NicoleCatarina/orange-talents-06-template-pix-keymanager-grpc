...
import br.com.zupacademy.nicolecatarina.pixkey.PixKeyRepository
        ...
        val expectedResponse = FindResponse.newBuilder()
                ...
                .setCustomerAccount(
                        CustomerAccount.newBuilder()
                                ...
                                .setAccountType(br.com.zupacademy.nicolecatarina.AccountType.valueOf(accountResponse.accountType.name))
