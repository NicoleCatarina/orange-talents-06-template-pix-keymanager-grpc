...
import br.com.zupacademy.nicolecatarina.*
import br.com.zupacademy.nicolecatarina.AccountType
import br.com.zupacademy.nicolecatarina.KeyType
import br.com.zupacademy.nicolecatarina.client.bcb.ChavePixBCBClient
import br.com.zupacademy.nicolecatarina.client.bcb.CreatePixKeyRequest
import br.com.zupacademy.nicolecatarina.client.bcb.DeletePixKeyRequest
import br.com.zupacademy.nicolecatarina.client.itau.ItauCustomerAccountClient
import br.com.zupacademy.nicolecatarina.exception.AccountNotFoundException
import br.com.zupacademy.nicolecatarina.exception.PixKeyAlreadyExistsException
import br.com.zupacademy.nicolecatarina.exception.PixKeyNotFoundException
...
//        }
    ...
    fun list(idCustomer: String): ListResponse {
        val pixKeys = pixKeyRepository.findAllByIdCustomer(idCustomer)
                .map { pixKey ->
                    br.com.zupacademy.nicolecatarina.PixKey.newBuilder()
                            .setIdPix(pixKey.id!!)
                            .setKeyType(KeyType.valueOf(pixKey.pixKeyType.name))
                            .setKeyValue(pixKey.pixKeyValue)
